...
import ProductList from "./Pages/Seller/ProductListScreen/index.jsx";
import ProductEdit from "./Pages/Admin/ProductEditScreen/index.jsx";
import OrderList from "./Pages/Admin/OrderListScreen/index.jsx";
    ...
    <Route path="/" element={<App />}>
      ...
      <Route path="/" element={<SellerRoute />}>
        ...
        <Route
          ...
          element={<ProductList />}
        />
        <Route path="/seller/product/:id/edit" element={<ProductEdit />} />
        <Route path="/seller/orderlist" element={<OrderList />} />
      </Route>
    </Route>
  )
);
